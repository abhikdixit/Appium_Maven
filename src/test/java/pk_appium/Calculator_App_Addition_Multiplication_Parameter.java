...
public class Calculator_App_Addition_Multiplication_Parameter {
	...
	public void Addition() throws Exception {
		...
		WebElement results = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.android.calculator2:id/formula")));
