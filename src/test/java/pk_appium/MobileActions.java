...
public class MobileActions {
    ...
    //Swipe by elements
    public void swipeByElements(WebElement getFirstElement, WebElement getSecondElement) {
        int startX = getFirstElement.getLocation().getX() + (getFirstElement.getSize().getWidth() / 2);
        int startY = getFirstElement.getLocation().getY() + (getFirstElement.getSize().getHeight() / 2);
 
        int endX = getSecondElement.getLocation().getX() + (getSecondElement.getSize().getWidth() / 2);
        int endY = getSecondElement.getLocation().getY() + (getSecondElement.getSize().getHeight() / 2);
